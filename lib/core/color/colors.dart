...
const pinkpurple = LinearGradient(
  ...
  colors: [Color(0xfff3696e), Color(0XFFf8a902)],
);
 LinearGradient pinkpurple2 = LinearGradient(
  begin: Alignment.centerLeft,
  end: Alignment.centerRight,
  colors: [Color(0xfff3696e).withOpacity(0.6), Color(0XFFf8a902).withOpacity(0.6)],
);
